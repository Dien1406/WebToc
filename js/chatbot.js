...
var MCK_ONINIT = "";
var KM_PLUGIN_SETTINGS = JSON.parse(
  '{"pseudoNameEnabled":true,"kommunicateApiUrl":"https://api.kommunicate.io","botPlatformApi":"https://bots.kommunicate.io","applozicBaseUrl":"https://chat.kommunicate.io","dashboardUrl":"https://dashboard.kommunicate.io"}'
);
var MCK_PLUGIN_VERSION = "v2";
var MCK_THIRD_PARTY_INTEGRATION = JSON.parse(
  '{"sentry":{"dsn":"https://9f71614ef8184d0cab00074555dad9a7@sentry.io/1321911","enabled":false},"aws":{"cdnUrl":"https://cdn.kommunicate.io","bucket":"kom-prod-cdn"}}'
);
...
function addKommunicatePluginToIframe() {
  ...
  imported.src =
    "https://widget.kommunicate.io/resources/kommunicate.468ec7a7.min.js";
